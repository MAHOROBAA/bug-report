...
또한 본 프로젝트는 생성형 AI를 실제 개발 과정에 적극 활용한 프로젝트입니다.

기획 단계에서는 ChatGPT와 Claude를 활용하여 기능 구조를 정리하고 사용자 흐름을 검토했으며, 개발 단계에서는 컴포넌트 설계, Firebase 데이터 구조 설계, 예외 처리 로직 검토 및 코드 개선 과정에 AI를 활용했습니다.

단순히 코드를 생성하는 도구로 사용하는 것이 아니라, 문제 해결을 위한 협업 도구로 활용하며 요구사항 분석부터 구현, 테스트, 배포까지 전 과정을 진행했습니다.

이를 통해 생성형 AI를 활용한 개발 생산성 향상과 반복 업무 자동화 가능성을 직접 경험할 수 있었습니다.
